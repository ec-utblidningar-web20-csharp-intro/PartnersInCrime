...
namespace Partners_In_Crime.Data
{
    public class DbInitializer
    {
        ...
        public static void Seed(ApplicationDbContext context)
        {
            var img = new UserImg
            {
              Content = ReadFile("Wireframes-img/UserImg.jpg") 
            };
            ...
            var testUsers = new List<AppUser>()
            {
                ...
                new AppUser {Age = 23, Description = "Hej! Ge mig en vän :(", FirstName = "Fake", LastName = "Fakesson", Email = "fakeuser@gmail.com", Country = "Sweden", City = "Gothenburg",
                            UserImg= new UserImg {Content = ReadFile("Wireframes-img/UserImg.jpg")} ,Interests = new List<Interest>() {interests[rnd.Next(interests.Count)], interests[rnd.Next(interests.Count)] }, Hobbies = new List<Hobby>() {hobbies[rnd.Next(interests.Count)], hobbies[rnd.Next(interests.Count)] }},
